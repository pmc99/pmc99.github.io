...
-------------------------------------------------------------------------------
This is bellanguage.txt interleaved with bel.bel source code.

Search for "NAME no" to find the source code for the "no" operator.
...
the first thing we need to check in applylit is whether we're in
...
Let's skip down to the locs defined after applylit to see some of
...
some slightly odd things. It created the pair (cell) to represent the
